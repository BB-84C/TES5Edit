...
The current local truth on this branch is now the accepted Phase 14 r5 UTF-8 inline-decode default on top of the Phase 13 `elements.*` mutation surface expansion, Phase 12 Starfield plain `.esp` write enablement, Phase 11 navigate-to-record, and the scoped xEdit-side `1.0` freeze:
