...
The current local truth on this branch is now the accepted Phase 12 Starfield plain `.esp` write enablement on top of Phase 11 navigate-to-record and the scoped xEdit-side `1.0` freeze:
